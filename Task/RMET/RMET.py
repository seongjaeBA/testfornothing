...
expName = 'RMET'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\OBELAB_JH_DESKTOP\\Documents\\\\testfotnothing\\OBELAB\\RMET\\RMET.py',
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='마음 읽기 과제입니다.\n\n이제부터 사람의 눈 사진이 화면에 나올겁니다.\n사진 속 사람의 기분을 맞춰주시면 됩니다. \n사진 아래에 나오는 예제를 보고 골라주세요.\n혹시 생각한 답이 아래에 없어도 최대한 보기에서 선택해주세요\n\n스페이스바를 누르면 넘어갑니다.',
    font='Arial',
...
image_2 = visual.ImageStim(
    ...
    image='sti/ex/여성7.png', mask=None,
    ori=0, pos=(0, 0.15), size=(1, 0.4),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
text_6 = visual.TextStim(win=win, name='text_6',
    text='1.기쁜 2.슬픔 3.공포 4.놀람\n\n위의 단어 중에서 사진 속 인물의 기분을 골라주세요.',
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='default text',
    font='Arial',
    pos=(0.45, -0.2), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0)
text_2 = visual.TextStim(win=win, name='text_2',
    text='default text',
    font='Arial',
    pos=(0.15, -0.2), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-3.0)
...
instructionComponents = [text_5, key_resp_3]
...
# keep track of which components have finished
pracComponents = [image_2, text_6, key_resp_4]
...
for thisTrial in trials:
    ...
    text_4.setText(An_D)
    # keep track of which components have finished
    trialComponents = [image, key_resp_2, text, text_2, text_3, text_4]
